...
class BaseStepper extends StatefulWidget {
  ...
  /// The color of the step when it is finished.
...
class _BaseStepperState extends State<BaseStepper> {
  ...
  /// Sửa màu nền các step đã hoàn thành. (index < _selectedIndex)
  Widget _customizedIndicator(int index) {
    return BaseIndicator(
      ...
      onPressed: widget.stepTappingDisabled
          ...
          : null,
      color: index < _selectedIndex ? widget.finishColor : widget.stepColor,
  ...
  /// Sửa thành line. Đổi màu line các step line đã hoàn thành  (index < _selectedIndex)
